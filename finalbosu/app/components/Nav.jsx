...
export const Nav = () => {
  ...
  return (
    <div className="w-full text-[#e61949] bg-[#06053897] px-2  lg:px-8 bg-bluenoise-layer bg-repeat bg-center bg-[length:100px_100px] flex flex-col justify-center items-center gap-2 lg:gap-4 pt-2 lg:pt-4">
